...
namespace CK.AspNet.Auth
{
    ...
    /// attempt to bind an aount and log in the user based on any criteria exposed by this context.
    /// </summary>
    public interface IWebFrontAuthAutoBindingAccountContext
    {
        ...
        /// <summary>
        /// Gets the inital authentication infos of the previous authentication.
        /// </summary>
        ...
        AccountBindingResult SetError( string errorId, string errorText = null );
        ...
        AccountBindingResult SetError( Exception ex );
    }
}
