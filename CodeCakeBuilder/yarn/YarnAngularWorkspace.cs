...
namespace CodeCake
{
    public class YarnAngularWorkspace : YarnProjectContainer
    {
        public YarnProject WorkspaceProject { get; }

        YarnAngularWorkspace(
            YarnProject workspaceProject,
            IReadOnlyList<YarnProject> projects )
            : base()
        {
        ...
        public static YarnAngularWorkspace Create( StandardGlobalInfo globalInfo, YarnSolution npmSolution, NormalizedPath path )
        {
            ...
            List<YarnProject> projects = new List<YarnProject>();
            ...
            return new YarnAngularWorkspace( YarnPublishedProject.Create( globalInfo, npmSolution, path, path ), projects );
        }
    }
}
