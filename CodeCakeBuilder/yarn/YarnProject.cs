...
namespace CodeCake
{
    ...
    public class YarnProject
    {
        ...
        protected YarnProject(
            StandardGlobalInfo globalInfo,
            YarnSolution npmSolution,
            YarnSimplePackageJsonFile json,
        ...
        protected static YarnProject CreateYarnProject(
            StandardGlobalInfo globalInfo,
            YarnSolution npmSolution,
            YarnSimplePackageJsonFile json,
            NormalizedPath outputPath )
        {
            return new YarnProject( globalInfo, npmSolution, json, outputPath );
        }


        public StandardGlobalInfo GlobalInfo { get; }

        public YarnSolution NpmSolution { get; }

        public virtual bool IsPublished => false;

        public NormalizedPath DirectoryPath { get; }

        public YarnSimplePackageJsonFile PackageJson { get; }
        ...
        /// <summary>
        /// Runs "yarn install --frozen-lockfile" (instead of "npm ci") on this project.
        ...
        {
            return YarnTempFileTextModification.TemporaryReplacePackageVersion( !targetOutputPath ? PackageJson.JsonFilePath : OutputPath.AppendPart( "package.json" ), version );
        }
        ...
        {
            return YarnTempFileTextModification.TemporaryReplaceDependenciesVersion( NpmSolution, OutputPath.AppendPart( "package.json" ), ckliLocalFeedMode, version, packageJsonPreProcessor );
        }
        ...
        {
            return YarnTempFileTextModification.TemporaryInjectNPMToken( NPMRCPath, pushUri, PackageJson.Scope, ( npmrc, u ) => npmrc.Add( u + ":_authToken=" + token ) );
        }

        public IDisposable TemporarySetPushTargetAndPasswordLogin( string pushUri, string password )
        {
            return YarnTempFileTextModification.TemporaryInjectNPMToken( NPMRCPath, pushUri, PackageJson.Scope, ( npmrc, u ) =>
            {
