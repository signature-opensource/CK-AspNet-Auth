...
namespace CodeCake
{
    public readonly struct YarnSimplePackageJsonFile
    {
        ...
        public static YarnSimplePackageJsonFile Create( ICakeContext cake, NormalizedPath folderPath )
        {
            ...
            return new YarnSimplePackageJsonFile( jsonFilePath, name, scope, shortName, version, scripts, isPrivate, ckliLocalFeedMode );
        }
    }
}
